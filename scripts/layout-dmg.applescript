on run argv
    ...
    set backgroundFile to (POSIX file (mountPath & "/Activity Tracker.app/Contents/Resources/DMGBackground.tiff")) as alias
    ...
    tell application "Finder"
        tell folder diskFolder
            ...
            set position of item "Activity Tracker.app" of container window to {166, 175}
